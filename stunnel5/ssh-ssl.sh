...
# install stunnel 5
cd /root/
wget -q -O stunnel5.zip "https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/stunnel5.zip"
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/stunnel5.init"
